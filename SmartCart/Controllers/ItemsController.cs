...
namespace SmartCart.Controllers
{
    public class ItemsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Item.Include(i => i.Category).Include(i => i.Order);
        ...
        public async Task<IActionResult> Create([Bind("Id,Productname,Description,Quantity,Price,Orderid,Categoryid")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Productname,Description,Quantity,Price,Orderid,Categoryid")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
